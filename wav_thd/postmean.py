...
"""
import sys
from wav_thd.postmean_cauchy import postmean_cauchy
from wav_thd.postmean_laplace import postmean_laplace
...
def postmean(x, s=1, w=0.5, prior="laplace", a=0.5):
    ...
    Finds the corresponding posterior mean estimate(s) for a given x, s, w, and a.
